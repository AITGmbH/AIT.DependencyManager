...
namespace AIT.AIT_DMF_DependencyManager
{
    ...
    /// </summary>
    [Guid(GuidList.guidAIT_DMF_DependencyEditorFactoryString)]
    public class VisualEditorFactory : IVsEditorFactory, IDisposable
    {
        #region Fields
        ...
        /// </summary>
        public VisualEditorFactory()
        {
            Trace.WriteLine(string.Format(CultureInfo.CurrentCulture, "Entering {0} constructor", typeof (VisualEditorFactory)));
        }
