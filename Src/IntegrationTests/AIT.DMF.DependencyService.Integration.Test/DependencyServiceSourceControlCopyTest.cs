...
{
    [TestClass]
    public class DependencyServiceSourceControlCopyTest
    {
        ...
        public void Init()
        {
            ...
            _workspaceName = $"{_workspaceName}_{guid}";

            SourceControlPreparation.PrepareSourceControlTestEnvironment(Values.WorkspaceOwner, Values.Password, Values.TeamProjectCollection, Values.TeamProjectName, _workspaceName, _localWorkspaceFolder);
        }

        [TestMethod]
        [TestCategory("IntegrationTest")]
        public void SourceControlCopy_Resolver_Success()
        {
            // Arrange:
